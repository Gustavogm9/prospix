...
export const webhookRoutes: FastifyPluginAsync = async (app) => {
  ...
  app.post('/asaas', async (req: FastifyRequest, reply: FastifyReply) => {
    ...
    // Wrap the entire billing / payment lookup and updates in an RLS bypass scope
    // since the external payment provider updates billing data across all tenants globally.
