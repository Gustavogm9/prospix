      ...
      <div className="bg-white border border-[#E5E7EB] rounded-xl overflow-hidden shadow-sm">
        <div className="px-4 py-3 border-b border-[#EEF0F3] flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[11px] font-mono text-[#94A3B8]">· {referrals.length}</span>
          </div>
        </div>
        ...
        {referrals.length > 0 ? (
              ...
              return (
                <div key={ref.id} className="px-4 py-3 flex items-center gap-3 hover:bg-[#F9FAFB] transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-[11px] text-[#94A3B8]">{ref.createdAt} · {ref.phone || 'Sem telefone'}</div>
                  </div>
          ...
          <div className="px-4 py-8 text-center">
            ...
            <div className="text-[11px] text-[#94A3B8] mt-1">Compartilhe seu link acima para começar a indicar corretores!</div>
          </div>
        )}
      </div>
    </div>
