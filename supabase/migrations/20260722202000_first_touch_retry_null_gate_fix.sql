-- First-touch recovery null-gate fix.
-- Recreates the retry wrapper preserving the base view behavior where NULL
-- Guardian relevance/commercial checks do not block by themselves.
