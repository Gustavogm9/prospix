...
| 6 | Produto/Compliance | 85% | Bloqueado para go-live | UX LGPD operacional existe com schema/API/frontend/migration, links legais existem, claims publicos foram suavizados, numeros comerciais sem fonte foram removidos e o form da landing nao promete agendamento sem backend; achados AUD-P1-030/031/032 (revisao juridica, NDA, claims) foram resolvidos com NDA template criado, claims de landing suavizados e links legais presentes; ainda falta worker de fulfillment LGPD, retencao/subprocessadores e governanca comercial completa. |
